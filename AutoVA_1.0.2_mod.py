...
class IVProcedure(Procedure):
    ...
    AHE_field_step = FloatParameter('Step (A)', units='A', default=0.2)
    AHE_waiting_time = FloatParameter('Waiting Time (s)', units='s', default=0.1)
    ...
    def startup(self):
        ...
        self.meter = Keithley2400("GPIB1::10::INSTR")
        ...
        self.source = Keithley2400("GPIB1::10::INSTR")
                            ...
                            for i, voltage in enumerate(voltages_down):
                                ...
                                if i == len(voltages_down) - 1:
                                    ...
                                    for i, fieldcurrent in enumerate(steps):
                                        ...
                                        hallvoltage = self.ahe_meter.voltage
                                        fieldcurrent = float(self.kepcosource.query("MEAS:CURR?"))
                                        CurrentData.append(float(self.kepcosource.query("MEAS:CURR?")))
                                        HallVData.append(self.ahe_meter.voltage)
                            ...
                            for i, voltage in enumerate(minus_voltages_up):
                                ...
                                if i == len(minus_voltages_up) - 1:
                                    ...
                                    with concurrent.futures.ThreadPoolExecutor(max_workers=num_threads) as executor:
                                        # Use the executor to parallelize data collection
                                        futures = [executor.submit(collect_data, step) for step in steps]
...
#         log.info("initiate the AHE Measurement")
#         rm = pyvisa.highlevel.ResourceManager()
#         self.kepcosource = rm.open_resource("GPIB0::4::INSTR")
#         self.kepcosource.apply_current()
#         self.kepcosource.compliance_voltage = 29
#         self.kepcosource.current_range = 20


#         self.ahe_source = Keithley2400("GPIB0::18::INSTR")
#         self.ahe_source.apply_current()
#         self.ahe_source.compliance_voltage = 5                      # set the compliance voltage to 5V
#         self.ahe_source.source_current_range = 10
#         self.source_current = 0
...
#         self.ahe_meter = Keithley2400("GPIB0::18::INSTR")
#         self.ahe_meter.measure_voltage()
#         self.meter.voltage_nplc = 0.01
#         sleep(2)
...
#     def shutdown(self):
#         self.ahe_source.source_current = 0
#         self.kepcosource.source_current = 0
#         log.info("shutdown the keithley and kepco")
