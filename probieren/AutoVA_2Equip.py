...
1. keithley 2400: apply the E-field to the sample and apply the bias current
2. kepcosource: apply the magnetic field to the sample
3. electronic relay: switch one contact bonder to the top electrode (ITO)
