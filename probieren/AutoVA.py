...
1. keithley 2400: apply the E-field to the sample
2. keithley 2400: apply the bias current to the sample
3. kepcosource: apply the magnetic field to the sample
