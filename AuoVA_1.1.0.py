...
class IVProcedure(Procedure):
    ...
    def startup(self):
        ...
        """
        Configure the KEPCO source for the E-field application
        """
        ...
        log.info("Configuration for the KEPCO finished")
        """"
        Configure the Keithley source for the AHE measurement
        """
    ...
    def E_field_application(self):
        ...
        self.voltages_up = voltages_up
        self.voltages_down = voltages_down
        self.minus_voltages_up = minus_voltages_up
        self.minus_voltages_down = minus_voltages_down
